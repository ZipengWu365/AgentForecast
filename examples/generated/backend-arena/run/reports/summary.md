...
- candidate_backends: `ml_ridge, stats_ets, moving_average, naive, stats_arima, stream_ewm`
- artifact_count: `10`
- latest_observed: `2623.5400`
- projected_end: `2705.8438`

Compared 6 backend(s) and routed the series to 'ml_ridge'. Exported CSV, chart, card, markdown, and JSON artifacts.
